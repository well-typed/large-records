...
--
-- NOTE: We use this more specialized form of 'HasField' instead of a straight
-- copy of 'HasField', so that the plugin does not need to ever the 'Record'
-- type constructor (if it did, it would need to be defined here in this module,
