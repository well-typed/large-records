...
module Experiment.ApLet.Sized.R100 where

import TypeLet

import Bench.Types
import Common.FunOfArity.F100

applyF :: forall f r. Applicative f => F r -> f r
applyF f =
    -- 99 .. 90
    case letT (Proxy @(T 99 -> r))   of { LetT (_ :: Proxy l99) ->
    case letT (Proxy @(T 98 -> l99)) of { LetT (_ :: Proxy l98) ->
    case letT (Proxy @(T 97 -> l98)) of { LetT (_ :: Proxy l97) ->
    case letT (Proxy @(T 96 -> l97)) of { LetT (_ :: Proxy l96) ->
    case letT (Proxy @(T 95 -> l96)) of { LetT (_ :: Proxy l95) ->
    case letT (Proxy @(T 94 -> l95)) of { LetT (_ :: Proxy l94) ->
    case letT (Proxy @(T 93 -> l94)) of { LetT (_ :: Proxy l93) ->
    case letT (Proxy @(T 92 -> l93)) of { LetT (_ :: Proxy l92) ->
    case letT (Proxy @(T 91 -> l92)) of { LetT (_ :: Proxy l91) ->
    case letT (Proxy @(T 90 -> l91)) of { LetT (_ :: Proxy l90) ->
    -- 89 .. 80
    case letT (Proxy @(T 89 -> l90)) of { LetT (_ :: Proxy l89) ->
    ...
    case letT (Proxy @(T 00 -> l01)) of { LetT (_ :: Proxy l00) ->
      ...
      let -- 00 .. 09
          ...
          -- 90 .. 99
          f90 = castEqual f89 <*> pure (MkT 89)
          f91 = castEqual f90 <*> pure (MkT 90)
          f92 = castEqual f91 <*> pure (MkT 91)
          f93 = castEqual f92 <*> pure (MkT 92)
          f94 = castEqual f93 <*> pure (MkT 93)
          f95 = castEqual f94 <*> pure (MkT 94)
          f96 = castEqual f95 <*> pure (MkT 95)
          f97 = castEqual f96 <*> pure (MkT 96)
          f98 = castEqual f97 <*> pure (MkT 97)
          f99 = castEqual f98 <*> pure (MkT 98)

          res = castEqual f99 <*> pure (MkT 99)
