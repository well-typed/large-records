...
import qualified Experiment.SR_Unsafe.Sized.R090
import qualified Experiment.SR_Unsafe.Sized.R100
...
--        , bench "100" $ whnf Experiment.SR_Construct.Sized.R100.record 0
    ...
    , bgroup "SR_Unsafe" [
        ...
        , bench "090" $ whnf Experiment.SR_Unsafe.Sized.R090.record 0
        , bench "100" $ whnf Experiment.SR_Unsafe.Sized.R100.record 0
        ]
    , bgroup "SR_GetEvens" [
