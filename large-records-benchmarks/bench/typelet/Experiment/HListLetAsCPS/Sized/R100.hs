...
hlist = letT' Proxy $ \(_ :: Proxy r) -> castEqual @(HList r) $
    -- 99 .. 90
    letAs' (MkT 99 :* Nil)  $ \xs99 ->
    letAs' (MkT 98 :* xs99) $ \xs98 ->
    letAs' (MkT 97 :* xs98) $ \xs97 ->
    letAs' (MkT 96 :* xs97) $ \xs96 ->
    letAs' (MkT 95 :* xs96) $ \xs95 ->
    letAs' (MkT 94 :* xs95) $ \xs94 ->
    letAs' (MkT 93 :* xs94) $ \xs93 ->
    letAs' (MkT 92 :* xs93) $ \xs92 ->
    letAs' (MkT 91 :* xs92) $ \xs91 ->
    letAs' (MkT 90 :* xs91) $ \xs90 ->
    -- 89 .. 80
    letAs' (MkT 89 :* xs90) $ \xs89 ->
    letAs' (MkT 88 :* xs89) $ \xs88 ->
    letAs' (MkT 87 :* xs88) $ \xs87 ->
    letAs' (MkT 86 :* xs87) $ \xs86 ->
    letAs' (MkT 85 :* xs86) $ \xs85 ->
    letAs' (MkT 84 :* xs85) $ \xs84 ->
    letAs' (MkT 83 :* xs84) $ \xs83 ->
    letAs' (MkT 82 :* xs83) $ \xs82 ->
    letAs' (MkT 81 :* xs82) $ \xs81 ->
    letAs' (MkT 80 :* xs81) $ \xs80 ->
    -- 79 .. 70
    letAs' (MkT 79 :* xs80) $ \xs79 ->
